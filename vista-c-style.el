...
(defun vista-c-lineup-expression-plus-4 (langelem)
...
(defconst vista-c-style
  `((c-recognize-knr-p . nil)
    ...
    (c-offsets-alist . ((arglist-intro vista-c-lineup-expression-plus-4)
                        ...
                        (access-label . /)
                        (innamespace . 0))))
  "Vista C/C++ Programming Style")

(defun vista-set-c-style ()
  "Set the current buffer's c-style to Google C/C++ Programming
  Style. Meant to be added to `c-mode-common-hook'."
  (interactive)
  (make-local-variable 'c-tab-always-indent)
  (setq c-tab-always-indent t)
  (c-add-style "Vista" vista-c-style t))

(defun vista-make-newline-indent ()
...
(provide 'vista-c-style)
;;; vista-c-style.el ends here
